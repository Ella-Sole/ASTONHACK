...
<body>
    ...
    <main>
        ...
        <section id="Intro">
            <img src="<?php echo e(asset('images/LeafDecorationsNoBG.png')); ?>" alt="LeafDecor" class="decor">
        ...
        <section id="HowItWorks">
            ...
            <img src="<?php echo e(asset('images/LeafDecorationsNoBG.png')); ?>" alt="LeafDecor" class="decor2">
...
<p>Cost-Effective Environmental website: As a digital platform, Eco Quest offers a cost-effective way to reach and educate a large audience about environmental issues.</p>
        ...
        <section id="LogActivity">            
            ...
            <article id="PointsDisplay">
                ...
                <img src="<?php echo e(asset('images/EnvironmentalPros.png')); ?>" alt="">
        ...
        <img src="<?php echo e(asset('images/LeafDecorationsNoBG.png')); ?>" alt="Logo" id="LogoInIntro">
...
</html><?php /**PATH C:\xampp\htdocs\EcoQuest\resources\views/homepage.blade.php ENDPATH**/ ?>