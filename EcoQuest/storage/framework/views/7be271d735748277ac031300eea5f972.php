...
<body class = "login-bg">
    ...
    <nav>
        ...
        <div id="form">
            <form id="SignIn" action="<?php echo e(route('loginUser')); ?>" method="POST">>
                <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('/login.js')); ?>"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\EcoQuest\resources\views/login.blade.php ENDPATH**/ ?>